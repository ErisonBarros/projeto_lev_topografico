...
*CREA:* ______________________________________________  
...
O levantamento planialtimétrico é essencial para:

- Determinar a geometria real da área;  
- Registrar as feições urbanas, naturais e estruturais;  
- Subsidiar cálculos hidrológicos e hidráulicos para drenagem;  
- Assegurar precisão posicional de acordo com normas ABNT;  
- Produzir planos e relatórios técnicos adequados à escala 1:1000.
...
|-------|------|------------------|
| Engenheiro Responsável | | Coordenação geral, ajustes, validação técnica, ART |
| Técnico de Campo | | Implantação de pontos, operação de equipamentos |
| Piloto de RPA (Drone) | | Planejamento e execução dos voos |
| Processamento | | Geração de MDT, DSM, ortomosaico e 3D |

---

## **3.2 Serviços a Executar**
...
Inclui o levantamento de:

- Edificações;  
- Árvores e vegetação de maior porte;  
- Muros, cercas, vias, passeios;  
- Equipamentos públicos (PV, caixas, bueiros, postes etc.);  
- Limites e confrontações;  
- Feições ambientais e áreas sensíveis.

---

### ✅ **3.2.3 Levantamento das Obstruções ao Voo**
- Edificações altas;  
- Árvores;  
- Fiações e estruturas aéreas;  
- Torres e interiores.
...
## **4.1 Etapas**
a) Pesquisa e reconhecimento da área;  
b) Identificação e marcação dos pontos de apoio;  
c) Levantamento tridimensional dos pontos;  
d) Levantamento topográfico terrestre e aéreo;  
e) Processamento e checagem de consistência dos dados;  
...
# **5. EXIGÊNCIAS TÉCNICAS (ABNT)**

A planta deverá conter:

- Denominação da gleba;  
- Área e perímetro;  
- Azimutes (graus, minutos e segundos);  
- Distâncias lineares com duas casas decimais;  
- Coordenadas UTM (três casas decimais);  
...
- Monografias dos pontos de apoio;  
- Tabela de coordenadas UTM + altitudes;  
- Planilha de poligonação e irradiações;  
...
| Item | Quant. | Unidade | Valor Unit. | Valor Total |
|------|--------|---------|--------------|-------------|
| Implantação dos pontos de apoio | | | | |
| Levantamento terrestre | | | | |
| Levantamento aéreo (drone) | | | | |
| Processamento | | | | |
| Relatórios e plantas | | | | |
| Materiais e insumos | | | | |
| Locação de equipamentos | | | | |
| **TOTAL GERAL (R$)** | | | | **R$ _________** |

---

# **8. CRONOGRAMA FÍSICO-FINANCEIRO**

Mínimo exigido: **2 dias**

| Etapa | Dia 1 | Dia 2 | Percentual (%) | Valor (R$) |
|-------|-------|-------|----------------|------------|
| Reconhecimento e pontos de apoio | X | | | |
| Levantamento topográfico | X | X | | |
| Levantamento aéreo | | X | | |
| Processamento | | X | | |
| Produtos e entrega | | X | | |
...
# **10. GARANTIA E VIGÊNCIA**

A proposta é válida até a data final estipulada e o serviço terá garantia técnica de _____ meses após entrega.

---

# **11. DECLARAÇÃO DE RESPONSABILIDADE TÉCNICA**

O responsável técnico declara estar habilitado conforme a legislação profissional vigente e que a execução seguirá rigorosamente as normas ABNT aplicáveis.

**Responsável Técnico:**  
Nome: ____________________________________  
CREA: _____________________________________  
